#!/usr/bin/env bash
# Бэкафилл истории маркетплейса: открытие 1 июня, работа ~2.5 месяца до
# 21 августа. Кривая роста — две фазы: рост первые 4 недели (июнь,
...
DAYS=85  # 1 июня - 21 августа включительно
